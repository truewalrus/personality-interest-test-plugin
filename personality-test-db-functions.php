...
function ptest_insert_result($quiz_id, $result){
	...
	$data = array('name'=>$result["name"], 'tag'=>$result["tags"], 'description'=>$result["description"], 'image'=>$result["image"], 'quiz_id'=>$quiz_id );
...
function ptest_update_result($result_id, $result){
	...
	$data = array('name'=>$result["name"], 'tag'=>$result["tags"], 'description'=>$result["description"], 'image'=>$result["image"]);

...
<div class = "wrap">
	...
	<ol class = "ptest-help-ol">
		...
		<li>
			...
			<p class = "ptest-help-ol-p">Once you have filled out all the inputs and finished up adding as many Answers as you want, select Save and the Question will be added to your quiz. Add as many questions as you like to your quiz. To make changes to any Question, you can select Edit question, change whatever you like, and click Save. <a href = "#trp">The Results Page</a> deals with some HTML, if you do not want to deal with that right now, there is a default Result page already set up and you can head straight to <a href = "#atw">Adding the Quiz to Your Website</a>.</p>
		</li>
		<li>
